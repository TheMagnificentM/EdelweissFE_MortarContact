...
nimmt das Negativgebiet damit $65\,\%$ des Referenzquadrats ein gegenüber $12{,}4\,\%$
(ausgezählt auf demselben Gitter). Auch die Tiefe unterscheidet sich um mehr als eine
...
-- ein Faktor $40$ --, und das Negativgebiet bedeckt $12{,}4\,\%$ des Referenzquadrats statt
...
$\|\sum_f \bm n_f\|<10^{-14}$ in \code{compute\_normals} & Fläche (3D), Länge (2D) & 2D+3D & Test~11 (beide Varianten) \\
$|\tilde D_{jj}|\le10^{-30}$ (Division im Indikator) & Fläche & 2D+3D & Test~11 (beide Varianten) \\
