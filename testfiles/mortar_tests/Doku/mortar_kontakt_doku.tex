...
\bibitem[De Luca et al.(1996)]{deluca1996} T.~De~Luca, F.~Facchinei, C.~Kanzow: \emph{A semismooth equation approach to the solution of nonlinear complementarity problems}, Mathematical Programming 75 (1996), 407--439. (Nicht lokal vorliegend; als Beleg für die Globalisierung semiglatter Newton-Verfahren angeführt.)

\bibitem[Deuflhard(2004)]{deuflhard2004} P.~Deuflhard: \emph{Newton Methods for Nonlinear Problems -- Affine Invariance and Adaptive Algorithms}, Springer Series in Computational Mathematics~35, Springer, Berlin, 2004. (Nicht lokal vorliegend.)
