# POT Dejori – Ausziehversuch mit Penalty-Kontakt (C3D8/CONQUAD4)

Gegenstück zu `../hex8/`, das den Versuch mit **Lagrange-Multiplikatoren** rechnet.
...
* **Das Netz wird nicht kopiert**, sondern über `*include, input=../hex8/Mesh_POTDejori_edelweissfe.inp`
  eingebunden (18 MB). Wird `../hex8/` verschoben, laufen die Dateien hier ins Leere.
