...
# 1. SIMULATIONSDATEN
# =============================================================================
disp_data  = np.loadtxt(os.path.join(current_dir, "disp.csv"))
force_data = np.loadtxt(os.path.join(current_dir, "force.csv"))
...
ax.plot(
    ...
    label="FEM – MortarContact3D (linear elastisch)",
    zorder=5,
)
