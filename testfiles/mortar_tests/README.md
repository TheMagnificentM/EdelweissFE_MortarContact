...
|---|---|---|
| `01_node_normals` | Baustein | Knotennormale gegen die **analytische** Normale eines Zylinderausschnitts, mit geforderter Mindest-**Fehlerreduktion** bei Halbierung der Elementgröße (≥1,8 linear, ≥3,5 quadratisch — die Reduktion, nicht die Ordnung); auf einem **graduierten** Netz zusätzlich die **Gewichtung** zwischen den Nachbarfacetten, die auf gleichmäßigen Netzen prinzipiell unsichtbar ist und die die übrige Reihe deshalb nicht prüfen kann; Orientierung; und `N_a(ξ_b) = δ_ab` für alle sieben Elementtypen, also die Übereinstimmung der Knoten-Naturkoordinaten mit der Knotenreihenfolge der Formfunktionen |
